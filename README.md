...
- ![#f03c15](https://placehold.it/15/f03c15/000000?text=+) `NOTE:`<font color="darkblue">The Stack "Portainer" has do be added a second time. Only then portainer can be fully controlde by Portainer.</font>
	Name:	Portainer
